...
/**
 * SpecialCivilsFixture
 *
 */
class SpecialCivilsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'issue_date' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'วันที่ / ปี พศ.', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ราบการ', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2019-10-06 03:38:09',
            'modified' => '2019-10-06 03:38:09'
        ],
    ];
}
