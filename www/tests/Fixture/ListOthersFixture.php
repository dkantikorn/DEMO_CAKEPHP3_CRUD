 ...
 *
 */
class ListOthersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'issue_date' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'วันที่ ไม่มีใน MF', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2019-10-06 03:37:20',
            'modified' => '2019-10-06 03:37:20'
        ],
    ];
}
